    ...
    <div>
        <section>
            ...
            <pre id="Condit">
                ...
                politiques et pratiques quant à la manière dont nous recueillons, utilisons et divulguons les
                données à caractère personnel que nous recueillons sur nos plateformes numériques ou
                pendant nos événements.
                Nous vous recommandons de lire attentivement la présente Politique de confidentialité car
                elle contient des informations importantes sur vos données à caractère personnel.
        ...
        <section>
            ...
            <pre id="Condit">
                ...
                La BEMS Acupuncture Coopérative est une association d'acupuncteurs créée par un collectif 
                d'acupuncteurs spécialisé dans la pratique de l'acupuncture Chinoise et présidée par Tristan 
                Barès et BEMS Acupuncture Coopérative et régie par la loi n°87-571 du 23 juillet 1987 sur le 
                développement du mécénat, et ses modifications successives. Notre siège social se situe 24, 
                rue du Faubourg Saint-Honoré – 75008 PARIS.
                BEMS Acupuncture Coopérative est une Coopérative du groupe BEMS. BEMS Acupuncture 
                Coopérative est la société mère du groupe BEMS. Pour plus de détails sur le groupe
                BEMS, veuillez consulter le site de BEMS Acupuncture Coopérative : www.BEMS.com. Au sein 
        ...
        <section>
            ...
            <pre id="Condit">
                ...
                personne.
                Nous pouvons recueillir des données à caractère personnel directement auprès de vous (par
            ...
            <section>
                ...
                <pre id="Condit">
                    ...
                    - lorsque vous nous contactez via notre module de contact mis en ligne sur notre site
                    internet
                    - lorsque vous accédez à l’espace presse de notre site internet.
                    ...
                    nous contactant (y compris vos commentaires ou d’autres communications avec
                    nous).
                    Lorsque vous proposez votre candidature à l’un de nos programmes, lesdites informations
                    peuvent inclure :
                    ...
                    règlement de prestations, versements de bourse ou de soutien) ;
                    ...
                    détenons soient exactes à tout moment. Nous vous encourageons donc à mettre à jour vos
                    données au cas où des changements se produiraient. Nous pouvons également vous
                    demander de mettre à jour vos données de temps à autre.
                    Nous vous recommandons de ne fournir que les données demandées ou nécessaires à votre
            ...
            <section>
                ...
                <pre class="Condit">
                    ...
                    placés sur votre appareil. Certains cookies sont nécessaires au bon fonctionnement de notre
                    site et d’autres sont utilisés à des fins d’analyse qui nous aident à vous fournir des services
                    plus personnalisés et une meilleure expérience numérique. Pour plus d’informations sur les
                    cookies et pour savoir comment modifier vos préférences, veuillez lire notre Politique en
                    matière de cookies.
                    ...
                    des données, nous pouvons recueillir, utiliser et divulguer lesdites données pour les finalités
                    décrites dans notre Politique de confidentialité. Vous devez par exemple vous assurer que la
                    personne concernée a connaissance des divers sujets exposés dans notre Politique de
        ...
        <section>
            ...
            <pre class="Condit">
                ...
                abonnez à notre lettre d’information). Veuillez noter qu’avec cette base juridique
                particulière, vous avez le droit de révoquer votre consentement à tout moment (voir
                ci-dessous « Quels sont vos droits sur vos données à caractère personnel ? ») ;
                - le traitement est nécessaire dans le cadre d’un contrat entre BEMS Acupuncture 
                Coopérative et vous ;
                - nous avons un intérêt légitime pour effectuer le traitement et cet intérêt légitime
                n’est pas éclipsé par vos intérêts, droits fondamentaux ou libertés ;
                - nous devons traiter vos données à caractère personnel afin de respecter les lois et la
                règlementation en vigueur.
                Selon le contexte, nous pouvons utiliser vos données à caractère personnel pour :
                - traiter votre candidature à l’un de nos programmes ;
                - effectuer des vérifications pour vous identifier et vérifier votre identité ;
                - vous envoyer une lettre d’information (avec votre consentement préalable) ou des
                invitations à l’un de nos événements ;
                - répondre à vos questions, demandes et suggestions ;
                - gérer les événements auxquels vous vous êtes inscrit et/ou auxquels vous avez
                participé ;
        ...
        <section>
            ...
            <pre class="Condit">
                ...
                la défense de droits légaux.
                Afin de déterminer les durées de conservation les plus appropriées pour vos données à
                caractère personnel, nous avons spécifiquement pris en compte la quantité, la nature et la
                sensibilité de vos données à caractère personnel, les raisons pour lesquelles nous avons
                recueilli vos données à caractère personnel, ainsi que les exigences légales applicables. Par
                exemple :
                - En ce qui concerne les candidats à nos programmes boursiers ou à nos projets : vos
                données sont conservées pendant un an à compter de leur collecte puis supprimées ;
                - En ce qui concerne les destinataires de la lettre d’information : vos données sont
                conservées pendant trois ans à compter de votre dernière action, puis supprimées ;
                - En ce qui concerne les bénéficiaires de bourses : vos données sont conservées
                pendant maximum d’attribution de la bourse et jusqu’à cinq ans maximum, puis
                supprimées ou archivées afin de respecter les obligations légales de conservation ;
                - En ce qui concerne les lauréats de projets : vos données sont conservées pendant
                cinq ans maximum, puis supprimées ou archivées afin de respecter les obligations
        ...
        <section>
            ...
            <pre class="Condit">
                ...
                - Nous pouvons être tenus par les dispositions obligatoires d’une loi applicable ou dans
                le cadre d’une procédure judiciaire ou autre demande légale, de divulguer vos
                données à caractère personnel à des autorités ou à des tiers.
        ...
        <section>
            ...
            <pre class="Condit">
                ...
                Hermès Sellier et BEMS Acupuncture Coopérative ainsi que les prestataires indépendants agissant en
                notre nom dans le cadre de mesures de sécurité techniques et organisationnelles
                appropriées.
                BEMS Acupuncture Coopérative a mis en place des mesures de sécurité pour protéger vos
                données à caractère personnel contre tout accès et utilisation non autorisés. Nous suivons
                des procédures de sécurité appropriées dans la conservation et la divulgation de vos
                données à caractère personnel afin d’empêcher l’accès non autorisé par des tiers et d’éviter
                la perte accidentelle de vos données. Nous limitons l’accès à vos données à caractère
                personnel aux personnes qui ont réellement besoin d’y accéder pour des raisons
                professionnelles. Les personnes qui accèdent à vos données sont soumises à un devoir de
                confidentialité à l’égard de BEMS Acupuncture Coopérative.
                Nous avons également mis en place des procédures pour traiter toute atteinte présumée à
                la sécurité des données. Nous vous aviserons, ainsi que toute autorité de contrôle
                compétente, en cas d’atteinte présumée à la sécurité des données lorsque la loi nous
                impose de le faire.
                Nous exigeons également des personnes à qui nous transmettons vos données à caractère
                personnel qu’elles respectent ce qui précède. Malheureusement, la transmission
                d’informations via Internet n’est pas totalement sécurisée. Nous ne pouvons donc pas
                garantir la sécurité de vos données à caractère personnel que vous nous avez transmises via
                Internet. Une telle transmission se fait à vos propres risques et vous reconnaissez et
                acceptez que nous déclinons toute responsabilité en cas d’utilisation, de distribution, de
        ...
        <section>
            ...
            <pre class="Condit">
                ...
                Votre droit de rectification : le droit de nous demander de rectifier toute erreur dans vos
                données ou de les compléter.
                Votre droit à l’oubli : le droit de nous demander de supprimer vos données à caractère
                personnel, dans certaines situations.
                Votre droit à la limitation du traitement : le droit de nous demander de limiter le traitement
                de vos données à caractère personnel, dans certaines circonstances, par exemple si vous
                contestez l’exactitude des données.
                Votre droit à la portabilité des données : le droit de recevoir les données à caractère
                personnel que vous nous avez fournies, dans un format structuré, couramment utilisé et
                lisible par machine et/ou de transmettre ces données à un tiers, dans certaines situations.
                ...
                - dans certaines autres situations, à la poursuite de notre traitement de vos données à
                caractère personnel, par exemple le traitement effectué sur la base de nos intérêts
                légitimes.
                Lorsque le traitement de vos données personnelles est basé sur votre consentement, vous
                pouvez à tout moment décider de retirer votre consentement au traitement de vos données
                à caractère personnel notamment lorsque vous ne souhaitez plus recevoir la lettre
                d’information à laquelle vous vous êtes inscrit. Si votre consentement est retiré, cela ne nous
                empêche pas de traiter vos données à caractère personnel en nous fondant sur d’autres
                bases juridiques, le cas échéant, l’intérêt légitime de la Fondation d’entreprise Hermès.
                Si vous ne souhaitez plus recevoir nos informations par mail, nous vous rappelons que vous
                pouvez révoquer votre consentement à tout moment directement à partir du lien de
                désabonnement inclus dans chaque message électronique que nous vous envoyons. Si vous
                le faites, nous mettrons rapidement à jour nos bases de données et prendrons toutes les
                mesures raisonnables pour répondre à votre demande le plus rapidement possible.
                Vous avez également le droit de déposer une plainte auprès de votre autorité locale de
                protection des données en cas de violation présumée des règles de protection des données
                qui vous sont applicables.
                Pour exercer l’un de ces droits, veuillez nous contacter en utilisant les coordonnées ci-
                dessous (voir « Comment nous contacter »).
                Veuillez noter que si vous exercez l’un des droits mentionnés ci-dessus, il vous sera demandé
                de nous faire savoir quel droit vous souhaitez exercer et de nous fournir certaines
        ...
        <section>
            ...
            <pre class="Condit">
                ...
                équipes :
                - Par courrier : Fondation d’entreprise Hermès, 24 Faubourg Saint-Honoré, 75008 Paris
                - Sur le site internet de la Fondation : via le formulaire de contact prévu à cet effet
                (www.BEMS.com)
        ...
        <section>
            ...
            <pre class="Contdit">
                ...
                indiquer quand de tels changements sont entrés en vigueur.
